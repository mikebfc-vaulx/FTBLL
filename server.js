...
const compatibleRoleMoves = {
  TS: ["DC", "AS"], TD: ["DC", "AD"], DC: ["TS", "TD", "MED"], MED: ["CC", "DC"],
  CC: ["MED", "COC"], COC: ["CC", "ATT"], AS: ["AD", "ATT", "TS"],
  AD: ["AS", "ATT", "TD"], ATT: ["AS", "AD", "COC"], POR: []
};
...
function teamStrength(lobby, manager) {
  ...
  const base = (avg * 0.76 + depth * 0.09 + individualPeak * 0.15) * chemistryMultiplier;
