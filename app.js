...
function renderLobby(snapshot) {
  ...
  $("lobbySettingsLabel").textContent = `${snapshot.settings.credits} crediti - ${snapshot.settings.rounds} giocatori in asta - ${snapshot.settings.botCount || 0} bot`;
  ...
  ["lobbyCreditsInput", "lobbyRoundsInput", "lobbyBotsInput"].forEach((id) => {
